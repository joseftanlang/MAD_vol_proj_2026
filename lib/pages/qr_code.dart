  ...
  Widget _buildQRCode() {
    return Column(
      children: [
        ...
        Text(
          AppLocalizations.of(context)!.qrUniqueMessage,
    ...
    return FutureBuilder<String>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Text(AppLocalizations.of(context)!.welcomeLoadError);
        } else {
          ...
          return Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  (showMyQR) ? AppLocalizations.of(context)!.qrCodeLabel : AppLocalizations.of(context)!.qrScannerLabel,
                  style: TextStyle(
                    fontSize: Theme.of(
                      context,
                    ).textTheme.headlineMedium?.fontSize,
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    if (scannedResult.isNotEmpty)
                      Padding(
                        ...
                        child: Text(
                          AppLocalizations.of(context)!.scannedResultLabel(scannedResult),
              ...
              ElevatedButton(
                ...
                child: Text(showMyQR ? AppLocalizations.of(context)!.scanQrButton : AppLocalizations.of(context)!.qrImageButton),
              ),
            ],
          ),
        ),
